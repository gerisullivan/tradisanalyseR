...
promoter_weblogo <- function(x, promoters, save_path, save_fasta = FALSE){
  for (i in seq(4, ncol(x), by=2)){
    ...
    RWebLogo::weblogo(as.character(data2$promoter), file.out = paste0(save_path, name, "_weblogo.png"), open = FALSE, format = "png",
            title = name, annotate = c(-50,"","","","",-45,"","","","",-40,"","","","",-35,
                                       "","","","",-30,"","","","",-25,"","","","",-20,"","",
                                       "","",-15, "","","","",-10,"","","","",-5,"","","",-1), xlabel = "position relative to TSS")
    if (save_fasta == TRUE){
